 ...
 * Local Signup Test
 *
 * Tests the local signup flow and session persistence
 * - Creates new user account
 * - Verifies cookie storage behavior
...
test.describe('Local Signup and Login Test', () => {
  test('should signup and persist session', async ({ page }) => {
    ...
    await page.goto(`${LOCAL_URL}/auth/signup`, {
    ...
    // Take screenshot
    await page.screenshot({ path: '/tmp/local-signup-test.png', fullPage: true });
    console.log('📸 Screenshot saved to /tmp/local-signup-test.png');
