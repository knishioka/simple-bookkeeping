  ...
  const fetchBankBook = async () => {
    ...
    try {
      const response = await apiClient.get<{ data: BankBookData }>(
        `/ledgers/bank-book?startDate=${startDate}&endDate=${endDate}`
      );
      if (response.data) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold">預金出納帳</h1>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="text-right">預入</TableHead>
                    <TableHead className="text-right">引出</TableHead>
